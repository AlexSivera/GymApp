...
void main() {
  ...
  test('v8 -> v9 migration adds theme_mode', () async {
    final tempDir = Directory.systemTemp.createTempSync('gymapp_migration_test_v8');
    final dbPath = p.join(tempDir.path, 'v8.sqlite');
    addTearDown(() => tempDir.deleteSync(recursive: true));

    // Minimal v8 shape: user_settings without theme_mode yet.
    final seed = sqlite3.sqlite3.open(dbPath);
    seed.execute('''
      CREATE TABLE user_settings (
        id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
