...
class ExerciseProgressScreen extends ConsumerWidget {
  const ExerciseProgressScreen({super.key, required this.exerciseId, required this.exerciseName});
              ...
              Expanded(
                child: AppCard(
                  child: Column(
                    ...
                    children: [
                      Text('Mejor peso', style: theme.textTheme.bodySmall
              ...
              Expanded(
                child: AppCard(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('1RM estimado', style: theme.textTheme.bodySmall
                          ?.copyWith(color: theme.colorScheme.onSurfaceVariant)),
                      const SizedBox(height: 4),
                      Text(
            ...
            data: (points) {
              ...
              final spots = [
                for (final p in points)
                  FlSpot(p.date.difference(firstDate).inDays.toDouble(), p.value)
              ];
